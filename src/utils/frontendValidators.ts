 ...
 */
import { BitcoinerFormData, SocialMediaData } from '@/types-old/bitcoiner'
 ...
 */
export const validateBitcoinerName = (
	name: string
 ...
 */
export const validateBitcoinerForm = (
	formData: BitcoinerFormData
): { isValid: boolean; errors: Record<string, string> } => {
	const errors: Record<string, string> = {}
