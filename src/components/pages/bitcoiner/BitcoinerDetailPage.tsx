...
export const BitcoinerDetailPage: React.FC<BitcoinerDetailPageProps> = ({ bitcoinerId }) => {
  const router = useRouter();
  const { bitcoiner, loading, error, deleteBitcoiner } = useBitcoiner(bitcoinerId);

  const handleDelete = async () => {
    if (confirm('Are you sure you want to delete this bitcoiner? This action cannot be undone.')) {
      try {
            ...
            <div className="flex items-center justify-center min-h-[400px]">
              <div className="text-center">
                ...
                <p className="text-muted-foreground mb-4">
                  The bitcoiner you're looking for doesn't exist or has been removed.
                </p>
                <Button onClick={() => router.push('/bitcoiner')}>
                  Back to Bitcoiners
                </Button>
