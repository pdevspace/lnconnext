import { Facebook, MessageCircle, Twitter, Send, Heart } from "lucide-react";
    ...
    <div className="bg-gray-50 pt-20 h-screen overflow-y-auto">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">About LNConnext</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            LNConnext คือ เว็บ Event Tracker ที่รวบรวมงานและกิจกรรมที่เกี่ยวข้องกับ Bitcoin ไว้ในที่เดียว 
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                เราอยากชวนทุกคนมาช่วยกันทำให้เว็บไซต์นี้มีประโยชน์ ใช้งานง่าย และข้อมูลครบถ้วนมากที่สุด
              </p>
              <p className="text-gray-600f mb-4">
                ไม่ว่าคุณจะเป็น developer, designer, หรือแค่ผู้ใช้งานทั่วไป ก็สามารถช่วยได้
              </p>
            </div>
            <div>
              <h3 className="text-lg font-medium text-gray-800 mb-3">How You Can Help</h3>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-lg font-medium text-gray-800 mb-4">Donate with Bitcoin Lightning Network</h3>
              <p className="text-gray-600 mb-4">
                Help us keep LNConnext running and improving by sending Bitcoin via Lightning Network
              </p>
              <div className="bg-gray-100 p-4 rounded-lg">
                <p className="text-sm font-medium text-gray-800 mb-2">Lightning Address:</p>
                <p className="font-mono text-blue-600 break-all">lnconnext@lnconnext.vercel.app</p>
              </div>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          <h2 className="text-2xl font-semibold text-gray-900 mb-6">Open Source</h2>
