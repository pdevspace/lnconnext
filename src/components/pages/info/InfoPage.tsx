	...
	return (
		<div className="bg-gray-50 dark:bg-gray-900 pt-20 min-h-screen">
			<div className="max-w-4xl mx-auto px-4 py-8">
				...
				<div className="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-gray-900/50 p-8 mb-8">
				...
				<div className="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-gray-900/50 p-8 mb-8">
					...
					<div className="grid grid-cols-2 md:grid-cols-4 gap-4">
						<Link
							...
							className="flex flex-col items-center p-4 rounded-lg hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors"
						>
							<Facebook className="h-8 w-8 text-blue-600 dark:text-blue-400 mb-2" />
						...
						<div className="flex flex-col items-center p-4 rounded-lg opacity-50">
							<Twitter className="h-8 w-8 text-blue-400 dark:text-blue-300 mb-2" />
							<span className="text-sm font-medium text-gray-700 dark:text-gray-300">
								Twitter
							</span>
						</div>
						...
						<div className="flex flex-col items-center p-4 rounded-lg opacity-50">
							<Send className="h-8 w-8 text-blue-500 dark:text-blue-400 mb-2" />
							<span className="text-sm font-medium text-gray-700 dark:text-gray-300">
								Telegram
							</span>
						</div>
				...
				<div className="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-gray-900/50 p-8">
					...
					<div className="text-center">
						...
						<Link
							...
							target="_blank"
							rel="noopener noreferrer"
							className="inline-flex items-center gap-2 px-6 py-3 bg-gray-900 dark:bg-gray-700 text-white dark:text-gray-100 rounded-lg hover:bg-gray-800 dark:hover:bg-gray-600 transition-colors"
						>
