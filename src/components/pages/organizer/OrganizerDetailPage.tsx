...
import { ArrowLeft, Calendar, Users, MapPin, Globe, Edit, Trash2, Building2 } from 'lucide-react';
...
export function OrganizerDetailPage({ organizerId }: OrganizerDetailPageProps) {
  ...
  const { organizer, loading, error, deleteOrganizer } = useOrganizer(organizerId);
            ...
            <div className="mb-8">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-muted-foreground">{organizer.events?.length || 0} events</p>
                </div>
                <div className="flex gap-2">
                  <Button
          ...
          <CardContent className="p-6">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h2 className="text-xl font-semibold mb-2">{organizer.name}</h2>
                {organizer.bio && (
                  <p className="text-muted-foreground mb-3">{organizer.bio}</p>
                )}
