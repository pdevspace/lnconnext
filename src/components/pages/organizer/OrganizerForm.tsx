...
import { Organizer, SocialMedia, OrganizerFormData } from '@/types/organizer';
import { validateOrganizerForm, sanitizeText, sanitizeUrl } from '@/utils/frontendValidators';
...
export const OrganizerForm: React.FC<OrganizerFormProps> = ({ 
  ...
  const handleInputChange = (field: keyof OrganizerFormData, value: string | boolean) => {
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Input
              id="name"
              value={formData.name}
              onChange={(e) => handleInputChange('name', sanitizeText(e.target.value))}
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => handleInputChange('website', sanitizeUrl(e.target.value))}
        ...
        <div className="space-y-2">
          ...
          <Textarea
            id="bio"
            value={formData.bio}
            onChange={(e) => handleInputChange('bio', sanitizeText(e.target.value))}
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => handleInputChange('avatar', sanitizeUrl(e.target.value))}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => updateSocialMedia(index, 'username', sanitizeText(e.target.value))}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => updateSocialMedia(index, 'displayText', sanitizeText(e.target.value))}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => updateSocialMedia(index, 'urlLink', sanitizeUrl(e.target.value))}
                      placeholder="https://..."
                    />
                  </div>
                </div>
