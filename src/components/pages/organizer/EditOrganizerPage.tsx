...
export const EditOrganizerPage: React.FC<EditOrganizerPageProps> = ({ organizerId }) => {
  const router = useRouter();
  const { organizer, loading, error, updateOrganizer } = useOrganizer(organizerId);
          ...
          <div className="max-w-2xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-muted-foreground mb-4">
                The organizer you're trying to edit doesn't exist or has been removed.
              </p>
              <Button onClick={() => router.push('/organizer')}>
                Back to Organizers
              </Button>
