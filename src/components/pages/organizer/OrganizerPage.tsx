...
import { getOrganizerById, getEventsByOrganizer } from "@/data/OrganizerService";
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-4">The requested organizer could not be found.</p>
          <Link href="/">
            <Button>
            ...
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  {organizer.socialMedia && Object.keys(organizer.socialMedia).length > 0 && (
                    <div className="flex gap-2">
                      {Object.entries(organizer.socialMedia).map(([platform, data]) => (
                        <a
                          key={platform}
                          href={data.urlLink}
                          target="_blank"
